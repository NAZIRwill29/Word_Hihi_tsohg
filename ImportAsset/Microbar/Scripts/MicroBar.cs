...
namespace Microlight.MicroBar
{
    ...
    {
        public bool isInitalized = false;   /// Safety system that gives out warning if health bar has not been initialized
        ...
        {
            isInitalized = true;
            //Debug.Log("Initialized " + isInitalized);
        ...
        public void UpdateBar(float newHP, bool skipAnimation = false, UpdateAnim updateType = UpdateAnim.Damage)
        {
            ...
            //Debug.Log("health() - UpdateBar " + GetTime.GetCurrentTime("full-ms"));
            CurrentValue = newHP;
